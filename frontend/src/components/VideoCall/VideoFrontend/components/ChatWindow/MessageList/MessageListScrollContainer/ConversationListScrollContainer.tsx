 ...
 */
export class ConversationListScrollContainer extends React.Component<
  ConversationListScrollContainerProps,
  ConversationListScrollContainerState
> {
  ...
  componentDidUpdate(prevProps: ConversationListScrollContainerProps, prevState: ConversationListScrollContainerState) {
    let hasNewMessages = false;
    if (this.props.conversations && prevProps.conversations) {
       hasNewMessages = this.props.conversations.length !== prevProps.conversations.length;
    }
    ...
    if (prevState.isScrolledToBottom && hasNewMessages) {
      ...
      if (this.props.conversations && prevProps.conversations) {
        numberOfNewMessages = this.props.conversations.length - prevProps.conversations.length;
      }
...
export default withStyles(styles)(ConversationListScrollContainer);
